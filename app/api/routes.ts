...
// Cricket routes
import cricketTeamsRouter from "~/cricket/routes/teams.routes";
import cricketMatchesRouter from "~/cricket/routes/matches.routes";
...
// Register cricket-specific routes first
router.use(cricketTeamsRouter);
router.use(cricketMatchesRouter);
