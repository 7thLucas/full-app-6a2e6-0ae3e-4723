...
export async function initializeModels(): Promise<void> {
  // Initialize cricket models explicitly
  await import("~/cricket/models/team.model");
  await import("~/cricket/models/match.model");
  await import("~/cricket/models/ball-event.model");
